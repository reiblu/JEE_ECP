...
public class TemaDaoJdbc extends GenericDaoJdbc<Tema, Integer> implements
	...
	public static String sqlToCreateTable() {
		return String.format(SQL_CREATE_TABLE, Tema.TABLA, Tema.NOMBRE,
	...
	public void create(Tema tema) {
		this.updateSql(String.format(SQL_INSERT, Tema.TABLA, Tema.ID,
				Tema.NOMBRE, Tema.PREGUNTA, tema.getId(), tema.getNombre(),
				tema.getPregunta()));
	}
	...
	public void update(Tema entity) {
		this.updateSql(String.format(SQL_UPDATE, Tema.TABLA, Tema.NOMBRE,
				entity.getNombre(), Tema.PREGUNTA, entity.getPregunta(),
				entity.getId()));
